...
INSERT INTO `concepts` VALUES (1,'cprogrammingquiz','Loops'),(2,'cprogrammingquiz','Functions'),(3,'cprogrammingquiz','Arrays'),(4,'cprogrammingquiz','Pointers');
...
INSERT INTO `java_questions` VALUES (1,'Introduction to Java','Who developed the Java programming language?','Dennis Ritchie','James Gosling','Guido van Rossum','Bjarne Stroustrup','B'),(2,'Introduction to Java','What does WORA stand for in the context of Java?','Write Once, Read Anywhere','Write Once, Run Anywhere','Write Once, Recompile Anywhere','Write Once, Run Anytime','B'),(3,'Introduction to Java','In which year was Java first publicly released?','1991','1994','1996','2000','C'),(4,'Introduction to Java','What is the primary feature of Java that allows it to run on different platforms without recompilation?','Garbage Collection','Bytecode and JVM','Dynamic Typing','Strong Typing','B'),(5,'Introduction to Java','Java was originally named ________.','Oak','Maple','Cedar','Pine','A'),(6,'Introduction to Java','Which of the following is NOT a characteristic of Java?','Object-oriented','Platform-dependent','Robust','Secure','B'),(7,'Introduction to Java','Which company currently owns Java?','Sun Microsystems','Microsoft','Oracle Corporation','Google','C'),(8,'Introduction to Java','Java syntax is most similar to which programming language(s)?','C/C++','Python','JavaScript','Ruby','A'),(9,'Introduction to Java','What does the Java compiler generate after compiling Java code?','Machine code','Bytecode','Assembly code','Intermediate code','B'),(10,'Introduction to Java','Who rewrote the Java 1.0 compiler to strictly comply with its specifications?','James Gosling','Patrick Naughton','Mike Sheridan','Arthur Van Hoff','D'),(11,'OOP Concepts','What does OOP stand for in Java?','Object-Oriented Programming','Open-Ended Programming','Object-Oriented Process','Organized Object Programming','A'),(12,'OOP Concepts','Which of the following is an OOP concept in Java?','Abstraction','Compilation','Debugging','Rendering','A'),(13,'OOP Concepts','What is a class in Java?','A blueprint from which objects are created','A variable used in the code','A method that performs tasks','A data structure used for storage','A'),(14,'OOP Concepts','What is an object in Java?','A real-world entity represented in code','A type of class','A method that operates on data','A part of an array','A'),(15,'OOP Concepts','What is the purpose of a method in Java?','To perform a specific task','To declare variables','To create objects','To store data','A'),(16,'OOP Concepts','What does encapsulation help with in Java?','Hiding the implementation details','Increasing execution speed','Reducing memory usage','Decreasing code complexity','A'),(17,'OOP Concepts','Which keyword is used to declare an abstract class in Java?','abstract','interface','private','final','A'),(18,'OOP Concepts','What is inheritance in Java?','A mechanism where one class inherits the fields and methods of another','A way to hide data from other classes','A technique for method overloading','A type of exception handling','A'),(19,'OOP Concepts','What is polymorphism in Java?','The ability of an object to behave in different ways','The process of combining data and methods','The ability to create multiple objects from the same class','The process of hiding an object\'s properties','A'),(20,'OOP Concepts','Which of the following is an example of compile-time polymorphism in Java?','Method Overloading','Method Overriding','Exception Handling','Dynamic Binding','A'),(21,'Java Collections','What is the main advantage of the Java Collection Framework?','Consistent API and high-performance implementations','It allows multi-threading','It simplifies networking','It provides database access','A'),(22,'Java Collections','Which interface is the root interface for the collection classes in Java?','Collection','List','Set','Map','A'),(23,'Java Collections','Which of the following is a subclass of Vector in Java?','Stack','LinkedList','ArrayList','PriorityQueue','A'),(24,'Java Collections','Which class implements the List interface and stores elements in a dynamic array in Java?','ArrayList','LinkedList','Stack','PriorityQueue','A'),(25,'Java Collections','Which of the following interfaces is extended by the Deque interface in Java?','Queue','List','Collection','Set','A'),(26,'Java Collections','Which class implements the Queue interface and stores elements based on their priorities in Java?','PriorityQueue','LinkedList','Stack','ArrayDeque','A'),(27,'Java Collections','What is the characteristic of the Stack class in Java?','Follows the Last-In-First-Out (LIFO) order','Follows the First-In-First-Out (FIFO) order','Allows random access to elements','Does not allow duplicate elements','A'),(28,'Java Collections','What is a major advantage of using ArrayDeque over ArrayList in Java?','ArrayDeque is faster and has no capacity restrictions','ArrayDeque supports random access to elements','ArrayDeque allows duplicate elements','ArrayDeque implements the Set interface','A'),(29,'Java Collections','Which interface maintains the First-In-First-Out (FIFO) order in Java?','Queue','List','Deque','Set','A'),(30,'Java Collections','What is the primary feature of the LinkedList class in Java?','It uses a doubly linked list internally','It uses a dynamic array internally','It supports the Stack interface','It stores elements based on priorities','A'),(31,'Java Control Statements','Which statement is used to transfer the control to the next statement outside a loop or switch statement in Java?','break','continue','if','for','A'),(32,'Java Control Statements','What type of loop should you use when the number of iterations is known in advance in Java?','for loop','while loop','do-while loop','for-each loop','A'),(33,'Java Control Statements','Which of the following is an entry-controlled loop in Java?','while loop','do-while loop','for loop','All of the above','A'),(34,'Java Control Statements','What is the primary difference between a for loop and a while loop in Java?','For loop is used when the number of iterations is known in advance','While loop is faster than for loop','For loop doesn’t check the condition before execution','While loop is always exit-controlled','A'),(35,'Java Control Statements','In Java, which statement is used to skip the current iteration of a loop and jump to the next iteration?','continue','break','return','exit','A'),(36,'Java Control Statements','Which statement is a decision-making statement in Java?','if statement','for loop','while loop','continue','A'),(37,'Java Control Statements','Which of the following statements is true about a switch statement in Java?','It contains multiple blocks of code called cases','It can only be used with integer values','It is slower than if-else statements','It cannot be used with characters','A'),(38,'Java Control Statements','In Java, what type of if-statement allows multiple else-if blocks?','if-else-if ladder','simple if','nested if','if-else','A'),(39,'Java Control Statements','What is the condition checking point in a do-while loop in Java?','After the loop body','Before the loop body','At the start of each iteration','It does not check the condition','A'),(40,'Java Control Statements','Which of the following is a feature of a nested if-statement in Java?','An if or if-else statement can be inside another if or else-if statement','It can only be used for two conditions','It is always executed regardless of the condition','None of the above','A');
...
DROP TABLE IF EXISTS `java_quizzes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `java_quizzes`
--

LOCK TABLES `java_quizzes` WRITE;
/*!40000 ALTER TABLE `java_quizzes` DISABLE KEYS */;
/*!40000 ALTER TABLE `java_quizzes` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `questions` VALUES (1,'What is the capital of France?','Paris','Berlin','Madrid','Rome',1),(2,'What is 5 + 3?','6','7','8','9',3);
...
CREATE TABLE `quizzes` (
  ...
  PRIMARY KEY (`id`),
  KEY `sub_concept_id` (`sub_concept_id`),
  CONSTRAINT `quizzes_ibfk_1` FOREIGN KEY (`sub_concept_id`) REFERENCES `concepts` (`id`)
...
INSERT INTO `quizzes` VALUES (1,1,'What is a loop?','A control structure','A function','A pointer','None of the above',1),(2,1,'Which loop is entry-controlled?','For loop','While loop','Both','None',3),(3,2,'What is a function?','A control structure','A block of code','An array','None of the above',2);
...
INSERT INTO `signup` VALUES (1,'hello','hello@mail.com','12345','12345','0000-00-00 00:00:00'),(2,'ghftft','jhgfjf@!33','123456','123456','2025-01-04 10:12:38'),(3,'ghftft','jhgfjf@!33','123456','123456','2025-01-04 10:12:42'),(4,'ghftft','jhgfjf@!33','123456','123456','2025-01-04 10:12:43'),(5,'asdfg','asdfg@gmail.com','123456','123456','2025-01-04 10:13:26'),(6,'qwerty','qwerty@gmail.com','98765','98765','2025-01-04 10:18:21'),(7,'sss','asdsadf@gmail.com','123456','','2025-01-05 09:55:40'),(8,'xxx','xxx@gmail.com','123456','','2025-01-05 10:19:15'),(9,'aaa','aaa@gmail.com','aaaaaa','','2025-01-06 08:20:42'),(10,'hello','hello@gmail.com','123456','','2025-01-06 08:55:38'),(11,'dhanya','dhanya@gmail.com','123456','','2025-01-07 03:52:18'),(12,'abcdef','abcdef@gmail.com','abcdef','','2025-01-12 05:57:29'),(13,'abcdefg','abcdefg@gmail.com','abcdefg','abcdefg','2025-01-12 06:05:10'),(14,'rebu','kalluribhagyasree@gmail.com','12345678','12345678','2025-01-22 02:41:53'),(15,'bhagya','bhagya@mail.com','bhagya','bhagya','2025-01-24 00:11:28');
...
INSERT INTO `tutorials` VALUES (1,'cprogramming','C Programming is a powerful general-purpose programming language.'),(2,'java','Java is a versatile and widely-used programming language.'),(3,'python','Python is an interpreted, high-level, and general-purpose programming language.');
...
-- Dump completed on 2025-01-29 15:57:37
